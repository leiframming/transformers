#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/xalma/modular_xalma.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_xalma.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class XALMARMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        XALMARMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class XALMADecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: XALMAConfig, layer_idx: int):
        ...
        self.input_layernorm = XALMARMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = XALMARMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
class XALMAPreTrainedModel(PreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": XALMADecoderLayer,
        "attentions": XALMAAttention,
    }
    config_class = XALMAConfig


class XALMARotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: XALMAConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Optional[XALMAConfig] = None,
...
class XALMAModel(XALMAPreTrainedModel):
    def __init__(self, config: XALMAConfig):
        ...
        self.norm = XALMARMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = XALMARotaryEmbedding(config=config)
...
class XALMAForCausalLM(XALMAPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = XALMAForCausalLM.from_pretrained("meta-xalma/XALMA-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-xalma/XALMA-2-7b-hf")
...
class XALMAForSequenceClassification(GenericForSequenceClassification, XALMAPreTrainedModel):
    pass


class XALMAForQuestionAnswering(GenericForQuestionAnswering, XALMAPreTrainedModel):
    base_model_prefix = "transformer"  # For BC, where `transformer` was used instead of `model`


class XALMAForTokenClassification(GenericForTokenClassification, XALMAPreTrainedModel):
    pass
